...
<div class="container py-5">
    ...
    @if($orders->isEmpty())
        <div class="text-center py-5">
            <i class="fa fa-history" style="font-size:3rem; color:#d4af37;"></i>
                    ...
                    <div class="card-body p-4">
                        ...
                        <div class="d-flex justify-content-between align-items-center mb-4 flex-wrap gap-2">
                            ...
                            <span class="badge 
                                ...
                                @elseif($order->status === 'paid') bg-info text-dark
                                ...
                                @foreach($order->items as $item)
                                    <div class="d-flex gap-3 align-items-center">
                                        ...
                                        <div class="flex-grow-1 min-width-0">
                                            <p class="mb-1" style="color:#001f3f; font-weight:500; margin:0;">
                                                {{ $item->product->name }}
                                            </p>
                                        ...
                                        <div style="text-align:right; flex-shrink:0;">
                                            <small style="color:#d4af37; font-weight:600; display:block;">
                        ...
                        <div class="row mb-3 text-sm">
                            <div class="col-6 col-md-3">
                                ...
                                <p class="mb-0" style="color:#d4af37; font-weight:600; font-size:1.2rem;">
                                    ₱{{ number_format($order->total, 2) }}
                                </p>
                            </div>
                            <div class="col-6 col-md-3">
                                <small class="text-muted d-block mb-1">PAYMENT</small>
                                <p class="mb-0" style="color:#001f3f; font-weight:500;">
                                    {{ strtoupper($order->payment_method) }}
                                </p>
                            </div>
                            <div class="col-12 col-md-6">
                                <small class="text-muted d-block mb-1">SHIPPING</small>
                                <p class="mb-0" style="color:#001f3f; font-size:0.9rem;">
                                    {{ $order->address }}, {{ $order->city }}, {{ $order->province }} {{ $order->postal_code }}, {{ $order->country }}
                                    <br>
